...
- [Matsuda 1990](https://doi.org/10.1038/346561a0) — cloned the CB1 receptor (5,009 cit · Nature)
...
1. Anecdote became RCTs. The biggest change. The recent reviews rest on a new layer of randomized trials for agitation — [Herrmann 2019](https://doi.org/10.1016/j.jagp.2019.05.002) (nabilone RCT, cited by 3/6 recent), the two van den Elsen 2015 THC RCTs ([Neurology](https://doi.org/10.1212/wnl.0000000000001675), [J Am Geriatr Psychiatry](https://doi.org/10.1016/j.jagp.2015.07.011)), [Shelef 2016](https://doi.org/10.3233/jad-150915), and the THC dosing/safety work ([Ahmed 2015](https://doi.org/10.1007/s00213-015-3889-y)). The Johns Hopkins dronabinol RCT (run 2017–2024, published 2026) is the next link in a clean lineage: Volicer '97 → van den Elsen '15 → Herrmann '19 → Rosenberg '26.
2. A mechanism beyond CB1/CB2: PPAR. [O'Sullivan 2016](https://doi.org/10.1111/bph.13497) — "PPAR activation by cannabinoids" — is a genuinely new axis (cannabinoids acting via PPARγ, not just the classic receptors). Notably the same PPARγ pathway the scleroderma cannabinoid drug EHP-101 targeted — the cannabinoid-PPAR mechanism recurs across cases. Plus [Cassano 2017](https://doi.org/10.3389/fnins.2017.00030) (CB2 in neurodegeneration) and [Zou 2018](https://doi.org/10.3390/ijms19030833) (refreshed endocannabinoid-system review).
3. Imported rigor — and the harm side. The recent reviews cite [Whiting 2015](https://doi.org/10.1001/jama.2015.6358) (the JAMA gold-standard evidence review, 2,108 cit) and [Marconi 2016](https://doi.org/10.1093/schbul/sbw003) (cannabis → psychosis-risk meta-analysis). The old reviews were almost purely "promising"; the new ones weigh harms — the balanced posture the 2023 BMJ umbrella review embodies.
## 3 · The synthesis
...
- Treatment signal is firming up — for agitation, with a split result. The Johns Hopkins/Tufts dronabinol RCT ([Rosenberg et al. 2026](https://doi.org/10.1016/j.jagp.2025.10.011), run 2017–2024) was well tolerated and hit one of its two co-primary agitation endpoints — PAS decline of −0.74/week vs placebo, p=.015 — while the other (NPI-C agitation) was not significant (p=.094). Still meaningful, because the alternative (antipsychotics) carries black-box stroke/death warnings.
...
- Rosenberg PB, et al. Trial of dronabinol for agitation in Alzheimer's disease. Am J Geriatr Psychiatry 2026. [doi:10.1016/j.jagp.2025.10.011](https://doi.org/10.1016/j.jagp.2025.10.011)
